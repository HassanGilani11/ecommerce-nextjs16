...
export default function AdminShell({
    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full bg-sidebar text-sidebar-foreground py-6 border-r border-sidebar-border/10">
            <div className="px-6 mb-10">
                <Link href="/" className="flex items-center gap-3 group">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xl font-bold tracking-tighter text-sidebar-foreground leading-none">
                            {settings?.site_title || "AVANT-GARDE"}
                        </span>
                        <span className="text-[10px] text-sidebar-foreground/50 font-bold tracking-[0.2em] uppercase mt-1">
                            Admin Account
                        </span>
                    </div>
                </Link>
    ...
    return (
        <div className="flex min-h-screen bg-background text-foreground" data-admin-theme={user?.color_scheme || "default"}>
            <div className="flex w-full min-h-screen transition-colors duration-500 ease-in-out">
                {/* Desktop Sidebar */}
                ...
                <div className="flex-1 lg:pl-64 flex flex-col">
                    {/* Header */}
                    <header className="h-16 flex items-center justify-between px-4 sm:px-8 bg-background/80 backdrop-blur-md border-b border-border/50 sticky top-0 z-40">
                                    ...
                                    <Button variant="ghost" className="relative h-10 w-auto rounded-full pl-0 hover:bg-transparent">
                                        <div className="flex items-center gap-3 pl-2 sm:pl-0">
                                            <div className="text-right hidden sm:block">
                                                <p className="text-xs font-black text-foreground leading-none tracking-tight uppercase">
                                            ...
                                            <div className="h-8 w-8 rounded-full bg-sidebar-primary flex items-center justify-center text-sidebar-primary-foreground text-xs font-bold ring-2 ring-background ring-offset-2 overflow-hidden shadow-md">
                                                {user?.avatar_url ? (
