...
export default function AddBrandPage() {
    ...
    const [slug, setSlug] = React.useState("") // Can auto-generate or user input
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tighter">Add Brand</h1>
                        <p className="text-zinc-500 text-sm font-medium">Register a new brand partner and manage their identity.</p>
                    </div>
                </div>
